if (!iBeatPgTrend) {
  ...
  async function ib_saveToStorage(e, t) {
        ...
        if (i) {
          ...
          if (i.getRandomValues)
            return function (e) {
              ...
              return i.getRandomValues(t), t;
            };
        }
        return function (e) {
          var t,
            i = [];
          for (t = 0; t < e; t++) i.push(Math.floor(256 * Math.random()));
          return i;
        };
      })());
  })(),
    'true' === localStorage.getItem('ibeat_hud') && ib_loadHud(),
    (ib_addDefaultListener = function (e) {
      window.addEventListener(e, ib_eventReceived);
    }),
  ...
  function getValidatedValue(e, t) {
    return e || t;
  }
  function logaction(e) {
    iBeatPgTrend.logaction(e);
  }
